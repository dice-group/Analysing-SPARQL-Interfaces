...
import pandas as pd
df = pd.read_csv('/home/hashim/Documents/new_experiments/smartKG/smartKG-watdiv-100-million/SmartKG-WatDiv-100-million-above-9k-resultSize.csv')
# give column names
...
df['10k-RS'] = df['totalExecTimePerQuery']
df = df['10k-RS'].dropna()
print(df)
df.to_csv('/home/hashim/Documents/new_experiments/smartKG/smartKG-watdiv-100-million/10-RS.csv')

#print(df['totalExecTimePerQuery'])
#print(df['totalExecTimePerQuery'].dropna())
